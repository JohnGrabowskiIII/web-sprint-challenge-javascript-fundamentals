...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array) {
    let lowerNameArr = array.map(name => name.animal_name.toLowerCase());
    return lowerNameArr;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array) {
    let popuArray = array.filter(pop => pop.population < 5);
    return popuArray;
  }
  ...
  */
  ...
  function USApop(array) {
    let totalPop = array.reduce((acc, cVal) => {return (acc + cVal.population)}, 0);
    return totalPop;
  }
